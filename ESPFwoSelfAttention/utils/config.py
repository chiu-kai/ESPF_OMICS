# python3 ./ESPFwoSA_main.py --config utils/config.py
...
seed = 42
#hyperparameter
model_name = "Omics_ESPFwoSA_Model"
...
hyperparameter_folder_part = (f'Model{model_name}_{splitType}_Omics{[omic_type for omic_type in include_omics]}_ESPFwoSA').translate(__translation_table__)
