...
from utils.Omics_MACCS_Model import Omics_MACCS_Model
...
for fold, (id_unrepeat_train, id_unrepeat_val) in enumerate(kfold.split(id_unrepeat_train_val)):
    ...
    set_seed(seed)
    model = Omics_MACCS_Model(omics_encode_dim_dict, drug_encode_dims, activation_func, activation_func_final, dense_layer_dim, device,
