...
def kfold_run(hyperparameters,filename,skip_train_load_weight=None):
    ...
    if skip_train_load_weight is None:
        for fold, (id_unrepeat_train, id_unrepeat_val) in enumerate(kfold.split(id_unrepeat_train_val)):
            ...
            best_epoch, best_weight, best_val_loss, train_epoch_loss_list, val_epoch_loss_list, best_val_loss_mean_batch_train_loss = train( model, activation_func_final,
            ...
            kfold_train_loss[fold]= best_val_loss_mean_batch_train_loss # best epoch_val_loss's train loss
        ...
        save_path = f'/root/Winnie/PDAC/results/{filename}_BestFoldEpoch_loss{best_test_loss}_{hyperparametersave}.pt'
